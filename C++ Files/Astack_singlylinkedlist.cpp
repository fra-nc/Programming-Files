...
public:
    ...
    void display()
    {
        ...
        while (temp != NULL)
        {
            ...
            cout << "(" << temp->key << "," << temp->Reg_No << ","<<temp->Name<<")" << "   ->" << endl; 
...
int main()
{
    ...
    do
    {
        ...
        case 0:
            break;
        case 1:
            cout << "Enter KEY and DATA of NODE to push in the stack" << endl;
            cin >> key;
            cin >> Reg_No;
            cin >> Name;
            new_node->key = key;
        ...
        case 2:
            ...
            new_node = s1.pop();
            cout << "TOP of Stack is: (" << new_node->key << "," << new_node->Reg_No<< ","<<new_node->Name<< ")";
            delete new_node;
            cout << endl;
            break;
        case 3:
        ...
        case 4:
            ...
            else
            {
                ...
                new_node = s1.peek();
                cout << "TOP of Stack is: (" << new_node->key << "," << new_node->Reg_No <<  ","<<new_node->Name<<  ")" <<endl;
            }
            break;
        case 5:
